 ...
 */
public class TaskAcceptRequest extends BaseRequest {

    public TaskAcceptRequest(Context context, Intent intent) {
    ...
    public void run() {
        ...
        if (getResponseData().isSuccess()) {
            ...
            task.setTaskStatus(ItemStatus.STATUS_ACCEPTED.getStatusName());
